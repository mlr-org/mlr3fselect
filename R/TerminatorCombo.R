...
TerminatorCombo = R6Class("TerminatorCombo",
  ...
  public = list(
    #' @field terminators list of objects of class [Terminator]
    terminators = NULL,

    #' @description
    #' Create new `TerminatorCombo` object.
    #' @param terminators list of objects of class [Terminator]
    #' @return A `TerminatorCombo` object.
