...
#' The function [fsi()] creates a [FSelectInstanceBatchSingleCrit] and the function [fselect()] creates an instance
#' internally.
#'
#' @description
#' The instance contains an [ObjectiveFSelectBatch] object that encodes the black box objective function a [FSelector]
#' has to optimize.
...
#' The [FSelector] is also supposed to store its final result, consisting of a selected feature subset and associated
#' estimated performance values, by calling the method `instance$assign_result()`.
#'
...
#' }
FSelectInstanceBatchSingleCrit = R6Class(
