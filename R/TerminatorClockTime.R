...
#'
#' @description
#' Class to terminate the optimization either after the complete process took a number of seconds on the clock
...
TerminatorClockTime = R6Class("TerminatorClockTime",
  ...
  public = list(
    ...
    #' @description
    #' Create new `TerminatorClockTime` object.
    #' @return A `TerminatorClockTime` object.
    initialize = function() {
