...
#' test sets, storing the selected features during training, for each combination of subsample and learner.
#'
...
#'  will be passed on to the learners and each test set will be used for prediction.
...
embedded_ensemble_fselect = function(
  ...
  assert_task(task)
  learners = assert_learners(as_learners(learners), task = task, properties = "selected_features")
