test_that("extract_inner_fselect_archives function works with resample and cv", {
  ...
  expect_named(irr, c("iteration", "Petal.Length", "Petal.Width", "Sepal.Length", "Sepal.Width", "classif.ce", "runtime_learners", "timestamp", "batch_nr", "warnings", "errors", "resample_result", "task_id", "learner_id", "resampling_id"))
})
...
test_that("extract_inner_fselect_archives function works with benchmark and cv", {
  ...
  expect_named(ibmr, c("experiment", "iteration", "Petal.Length", "Petal.Width", "Sepal.Length", "Sepal.Width", "classif.ce", "runtime_learners", "timestamp", "batch_nr", "warnings", "errors", "resample_result", "task_id", "learner_id", "resampling_id"))
...
test_that("extract_inner_fselect_archives function works with multiple tasks", {
  ...
  expect_named(ibmr, c("experiment", "iteration", "Petal.Length", "Petal.Width", "Sepal.Length", "Sepal.Width", "age", "glucose", "insulin", "mass", "pedigree", "pregnant", "pressure", "triceps", "classif.ce", "runtime_learners", "timestamp", "batch_nr", "warnings", "errors", "resample_result", "task_id", "learner_id", "resampling_id"))
...
test_that("extract_inner_fselect_archives function works with mixed store instance", {
  ...
  ibmr = extract_inner_fselect_archives(bmr)
  expect_data_table(ibmr, ncols = 16)
